        ...
        <div id="player">
            ...
            <div id="player-content2">
                ...
                <div class="player-controls">
                    <!-- 上一首按钮 -->
                    <div class="btn prev iconfont">
                        <el-icon :size="40" color="#d6dee7">
                            <CaretLeft />
                        </el-icon>
                    </div>
                    <!-- 暂停/播放 按钮 -->
                    <div class="btn play-pause icon-jiediankaishi iconfont" @click="data.bozan = !data.bozan">
                        <el-icon :size="40" color="#d6dee7" v-if="data.bozan">
                            <VideoPlay />
                        </el-icon>
                        <el-icon :size="40" color="#d6dee7" v-else>
                            <VideoPause />
                        </el-icon>
                    </div>
                    <!-- 下一首按钮 -->
                    <div class="btn next iconfont">
                        <el-icon :size="40" color="#d6dee7">
                            <CaretRight />
                        </el-icon>
                    </div>
...
@import './MusicPlayPublic/css/style.css';
</style>
